...
- LEDE源码其实就一个master分支的，在我仓库还有一个gl-ax1800分支可以选择，是他另外一个仓库的源码，此源码是4.14内核的，《[点击查看源码]([https://github.com/x-wrt/x-wrt](https://github.com/coolsnowwolf/openwrt-gl-ax1800)))》
----
- # 2、<br>
